...
Most accessory slots are tied to the world. Only Torch God event is tied to the player in vanilla. The mod implements tModLoader's API for adding modded accessories.

All vanilla bosses and events are supported.

Added support for mods:

- Calamity, thanks to ProfiFaust (https://steamcommunity.com/id/ProfiFaust/) for pointing out what strings are needed.
